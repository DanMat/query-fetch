...
- Preferred: use GitHub's [**Report a vulnerability**](https://github.com/DanMat/query-fetch/security/advisories/new)
  (Security tab → Advisories), or
- Email **dannymatthew@gmail.com** with details and, if possible, a reproduction.
